...
# 词向量的评估
  ...
  - 外在评估：
    ...
    - 通常是间接的，很难判断任务中发生了什么
# 多义词
  - 判断词语有几种含义，然后在文本中提取词语的实例，基于它们出现的相似性对他们进行聚类，以确定将每个词元视为哪种词义，然后为这些作为词义的词元聚类学习词向量
  - 叠加：通常只为词设置一个向量，学到的那个向量是本应为各个义项学到的向量的加权平均；取不同义项的相对频率，然后乘以本应学到的向量，这就是得到的整体表示
  - 词向量的向量空间高维且稀疏，以至于可以使用稀疏编码理论的的思想从整体向量中重构出义项向量
